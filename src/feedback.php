...
Имя: <span style="font-weight:bold;color:#339900;">'.$_POST['input-name'].'</span><br> 
E-mail: <span style="font-weight:bold;color:#339900;">'.$_POST['input-mail'].'</span><br>'
'Сообщение: <span style="font-weight:bold;color:#339900;">'.$_POST['input-comment'].'</span><br>'; 
